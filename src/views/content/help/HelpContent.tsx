...
const SECTIONS: ManualSection[] = [
  ...
  },
  {
    ...
    keywords: ["formulaire", "création", "désignation", "type", "description", "fichier", "référence", "appareil", "espace personnel", "workspace", "source", "pré-remplissage", "obligatoire"],
    body: "Pour soumettre une archive cliquez sur le bouton Ajouter dans la barre de navigation gauche. Un formulaire s'ouvre avec les champs suivants : désignation (nom du document, obligatoire), type documentaire (catégorie administrative, obligatoire), numéro de référence (obligatoire), description et pièce jointe. Le dossier de classement est déterminé automatiquement à partir du type de document choisi. Pour joindre un fichier, vous avez le choix entre deux sources : Depuis mon appareil pour glisser-déposer un fichier ou le sélectionner depuis votre poste, ou Depuis mon espace personnel pour naviguer dans votre espace de travail et choisir un fichier déjà enregistré. Lorsque vous sélectionnez un fichier depuis votre espace personnel, le formulaire se pré-remplit automatiquement : la désignation reprend le nom du fichier, et le type documentaire est suggéré si possible. Vous pouvez bien sûr modifier ces valeurs avant de valider.",
  },
  {
  ...
  {
    id: "ouvrir-fichier", number: "10.10", title: "Ouvrir et consulter un fichier",
    keywords: ["ouvrir", "fichier", "chargement", "progression", "annuler", "hors ligne", "icône", "PDF", "Word", "Excel", "image", "vidéo", "lecteur", "viewer", "zoom", "pinch", "raccourci", "double-clic", "page", "recherche", "plein écran"],
    body: "Vous pouvez ouvrir un fichier en double-cliquant sur une archive dans la liste. Le lecteur intégré s'adapte automatiquement au type de fichier. Pour les documents (PDF, Word, présentations), chaque page est affichée individuellement avec une barre de navigation en bas permettant de parcourir les pages, zoomer et effectuer une recherche dans le texte. Pour les images, vous pouvez zoomer avec la molette, faire glisser l'image, la faire pivoter ou utiliser le pincement tactile. Pour les vidéos, le lecteur propose les contrôles classiques ainsi que le mode image dans l'image et le plein écran. Pour les fichiers audio, un lecteur avec visualisation est affiché. Raccourcis clavier disponibles dans le lecteur de documents : flèches gauche et droite pour changer de page, plus et moins pour zoomer, Ctrl+F pour rechercher dans le texte, Début et Fin pour aller à la première ou dernière page. Sur les appareils tactiles, le pincement à deux doigts permet de zoomer dans tous les lecteurs. Un fichier déjà consulté s'ouvre instantanément la prochaine fois grâce à la mise en cache locale.",
  },
  {
